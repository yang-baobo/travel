...
const styles = StyleSheet.create({
  ...
  categoryPill: { alignSelf: 'flex-start', borderRadius: 99, paddingHorizontal: 10, paddingVertical: 5, backgroundColor: '#EAF1FF' },
  ...
  tag: { backgroundColor: '#EEF3FB', borderRadius: 99, paddingHorizontal: 10, paddingVertical: 6 },
  tagText: { color: colors.textSecondary, fontSize: 12 },
  sourceNote: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.xl, padding: spacing.md, borderRadius: borderRadius.md, backgroundColor: '#F1F3F7' },
