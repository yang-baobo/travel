...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0D463F', borderRadius: borderRadius.lg, padding: spacing.lg, marginBottom: spacing.lg },
  heroIcon: { width: 48, height: 48, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0E9F93' },
  ...
  chipActive: { borderColor: colors.primary, backgroundColor: '#E6F5F1' },
  ...
  safetyCard: { backgroundColor: '#E6F5F1', borderRadius: borderRadius.lg, padding: spacing.lg, marginVertical: spacing.sm },
